									...
									<div style="width: 60%; ">
										...
										<ul class="statistics" style="position:relative">
										 ...
										 <Strong style="color:black; font-size:17px;">${reviewlist.memberprofile_name}  ${reviewlist.r_date}</Strong>  
											...
											<a  href="../../../Img/${reviewfilelist.file_name}"  data-lightbox="example-set5${reviewlist.memberprofile_u_key }"><span class="reviewimage"><img style="width:100px;" src="../../../Img/${reviewfilelist.file_name}" ></span></a>
...
function submitForm() {
	...
	var data = {   
		    "test" : test , "content" : content, "starR":starR ,"opencheck":opencheck, "trainerprofile_u_key":trainerprofile_u_key, "memberprofile_u_key":memberprofile_u_key
		    ,"memberprofile_name":memberprofile_name
