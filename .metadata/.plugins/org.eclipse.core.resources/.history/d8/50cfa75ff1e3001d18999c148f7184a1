			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						...
						<div id="tf_hanjulintroUpdateOk"></div>
							...
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
										...
										<div id="tf_introUpdateOk"></div>
										
										<textarea 	style="display: none; color:black;" rows="2" cols="120" name="" >${trainerprofile.tf_intro}</textarea>
