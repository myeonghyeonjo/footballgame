			...
			<label for="email" style="font-size: 20px; padding: 10px;" form-labelmt-4" ><strong>센터정보</label>
							...
							<label for="email" style="font-size: 20px; padding: 10px;"
								...
								style="padding: 10px; background-color: white;">
										...
										<p style="margin-top:8px;  margin-left:5px; margin-right:10px">	우편번호</p>
										<input type="text" style= "flex: 0.5; margin:2px;  " class="form-control"  name="c_postcode" id="sample4_postcode" 
...
<div id="map" style="width:600px;height:350px;"></div>
				...
				<input type="hidden"  style= "flex: 0.5; margin:2px;" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"  class="form-control" ><br>
								      <input type="hidden" id="tf_loadaddress" style= "flex: 0.5; margin:2px;" value="tf_loadaddress" ><br>
								      
								        <input type="hidden" id="c_name" style= "flex: 0.5; margin:2px;" value="c_name" ><br>			
<input type="hidden"  style= "flex: 0.5; margin:2px;" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"  class="form-control" ><br>
								      <input type="hidden" id="tf_loadaddress" style= "flex: 0.5; margin:2px;" value="tf_loadaddress" ><br>
    ...
    // 정상적으로 검색이 완료됐으면 
     if (status === kakao.maps.services.Status.OK) {
        ...
        var infowindow = new kakao.maps.InfoWindow({
            content: `<div style="width:150px;text-alig	n:center;padding:6px 0;">헬스장위치</div>`
        });
