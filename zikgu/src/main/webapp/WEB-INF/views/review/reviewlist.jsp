							...
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
										...
										<button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#reviewModal" data-ptid="${PT_List.pt_id}" data-ukey="${trainerprofile.u_key}" >리뷰 남기기</button>
...
<div class="modal fade" id="reviewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content modal-80size">
      ...
      <div class="modal-body">
		...
		(PT 약정서/계약서 or 코치님과 함께 찍은 사진 등 기타)</li>
		 ...
		 <li style="font-size:15px;">업로드된 사진을 터치/드래그 하여 삭제/이동 할 수 있습니다.</li>
  ...
  <span class="starR">⭐</span>
          ...
          <h6 style="color:black;"><Strong style="color:black;">증빙사진을 올려주세요</Strong></h6>
            ...
            <h6 style="color:black; margin-top:-100px;"><Strong style="color:black;">내용을 작성해주세요</Strong></h6>
            <div class="input-group has-validation">
								<textarea style="height:200px;"cols="30" rows="10" class="form-control" id="username" name="tf_intro"></textarea>
							</div>
