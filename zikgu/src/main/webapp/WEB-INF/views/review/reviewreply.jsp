			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<h1 id="c_name" style="color:white;">${trainerprofile.tf_name}</h1>
								...
								<div class="spotlight" style="display: flex;">
									...
									<div style="width: 100%;">
										<header class="major">
											...
											<h2 ><Strong style="color:black">리뷰 디테일</Strong></h2>
										</header>
										...
										<ul class="statistics" style="position:relative">
											<li class="style6">
											  ...
											  <h4 style="color:white;">등록된 리뷰를 확인하세요!</h4>
  ...
  <div class="modal-dialog modal-size">
    <div class="modal-content modal-size">
      <div class="modal-header">
        ...
        <h6 class="modal-title fs-5" id="exampleModalLabel" style="color:black;"><Strong style="color:black; font-size:20px;">답글을 남겨주세요!</Strong></h6>      </div>
      <div class="modal-body">
						<h6 style="color:black; margin-top:0px;"><Strong style="color:black; font-size:15px; text-align:left;">내용을 작성해주세요</Strong></h6>            <div class="input-group has-validation">
								<textarea style="height:200px;"cols="30" rows="10" class="form-control" id="r_reply" name="r_reply">${reviewlist.r_reply }</textarea>
							</div>
      </div>
										 ...
										 <c:if test="${reviewlist.r_starR==1}">
										  ...
										  <hr style="margin: 12px; color:white; border-width:2px 0 0 0;">
										  	...
										  	<sec:authorize access="hasRole('ROLE_ADMIN')">
									 			...
									 			<c:if test="${reviewlist.r_check == 2}">
													<p style="color:red; font-size:18px; margin-top:0px; font-weight:bold;">반려사유 : ${reviewlist.r_rejectreason }</p>			
												</c:if>
									 			<!-- 승인하기 Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" style="color:#2fa4e7;" class="btn btn-outline-primary" onclick="clickConfirm(reviewInfo)">승인하기</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" style="color:#2fa4e7;" class="btn btn-outline-primary" onclick="clickConfirmCancel(reviewInfo)">확인</button>
      </div>
    </div>
  </div>
</div>
        ...
        for (const file of obj.files) {
            ...
            if (validation(file)) {
                ...
                htmlData += '   <p class="name" style="color:black; margin-bottom:-30px;">' + file.name + '</p>';
				  ...
				  htmlData += '  <img src="http://15.164.62.221:8080/static/img/health/img/Xicon.JPG" style="height:20px; width:20px;  margin-left:0px; margin-top:-197px;  cursor:pointer;" alt="Button Icon">';
				  htmlData += '</div>';
            ...
            if (validation(file)) {
                ...
                let htmlData = '';
				  htmlData += '<div style="display: inline-block;  box-sizing: border-box; padding: 10px; margin-left:25px;" id="file' + fileNo + '" class="filebox2'+r_id+'">';
       			  htmlData +=  '<img src="'+value+'" title="'+file.name+'" width=100 height=100 />';
				  htmlData += '  <a class="delete" onclick="deleteFile(' + fileNo + ');">';
				  htmlData += '  <img src="http://15.164.62.221:8080/static/img/health/img/Xicon.JPG" style="height:20px; width:20px; margin-left:-52px; margin-top:-210px;  cursor:pointer;" alt="Button Icon">';
				  htmlData += '</div>';	
