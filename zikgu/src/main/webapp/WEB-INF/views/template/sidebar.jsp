...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-xs-3  col-lg-2 me-0 px-3 fs-6" href="#" id="headermenu1">검색 
	...
	<div id="headermenu2" style="">
		  <a class="navbar-brand col-md-3 col-xs-3  col-lg-3 me-0 px-3 fs-6" href="#">회원 프로필 관리	 
		</a>
		  <a class="navbar-brand col-md-3 col-xs-3  col-lg-2 me-0 px-3 fs-6" href="#">트레이너 프로필 관리
		</a>
		  <a class="navbar-brand col-md-3 col-xs-3  col-lg-2 me-0 px-3 fs-6" href="#">센터 관리
		</a>
