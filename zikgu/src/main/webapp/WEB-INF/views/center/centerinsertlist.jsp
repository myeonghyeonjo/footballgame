...
function completebutton_click() {
	...
	var u_key = $('#u_key').val();
	var path = '/centerconfirmcompletelist';
	var url = path + '?u_key=' + encodeURIComponent(u_key);
	location.href = url;
...
function waitebutton_click() {
	...
	var u_key = $('#u_key').val();
	var path = '/centerconfirmwaitelist';
	var url = path + '?u_key=' + encodeURIComponent(u_key);
	location.href = url;
}
...
function search_allbutton_click() {
	...
	var path = '/center_insert_search_All';
