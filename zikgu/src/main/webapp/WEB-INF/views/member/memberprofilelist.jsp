...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand headermenu1 col-md-3 col-lg-2 me-0 px-3 fs-6" >검색</a>
		  ...
		  <a  class="navbar-brand headermenu2 col-md-3 col-xs-3  col-lg-3 " id="nav_link_memberprofile2" href="/memberprofilelist">회원 프로필 관리	 
		</a>
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link sidemenu active" id="nav_link_memberprofile"aria-current="page" href="/memberprofilelist">
          ...
          <li class="nav-item sidemenu">
            <a class="nav-link" href="/centerlist">
    ...
    <main style="margin-top:5px;" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2" style="color:black;">회원목록</h1>
        ...
        <table class="table table-hover">
          ...
          <tbody>
		        <c:forEach var="list" items="${list }">
		           		<tr onclick="location.href='memberprofiledetail?m_id=${list.m_id }'" style="cursor:pointer">
				               <td>${list.m_id }</td>
		              <td>${list.m_name }</td>
