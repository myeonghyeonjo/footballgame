				...
				<div class="col-md-7 col-lg-8">
					...
					<div class="row g-3">
						...
						<div class="col-12">
								...
								<h5 style="color:black;"><Strong>토요일 </Strong>${memberprofile.m_saterdaymorning} ~ ${memberprofile.m_saterafter}</h5>
...
function modifyClick(formName) {
	  var m_id =$('#m_id').val(); 
	  console.log(m_id);
	  var url = "/memberprofilemodify?m_id=" + encodeURIComponent(m_id);  
