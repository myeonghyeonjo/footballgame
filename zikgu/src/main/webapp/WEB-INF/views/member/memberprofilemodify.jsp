					...
					<label for="email" style="font-size: 20px; padding:5px; form-labelmt-4" ><strong>회원명</label>
							...
							<div id="sectionbox" class="form-control"
								...
								<div style="display: flex;">
									...
									&nbsp;&nbsp;&nbsp; <input type="text" id="timeInput" name="m_sundaymorning" value="${memberprofile.m_sundaymorning }"
										style="width: 140px; flex: 0.2; height: 40px;"
										class="form-control numberOnly" oninput="formatTime(this)" maxlength="4" placeholder="00:00">~
									<input type="text" id="timeInput"
										style="width: 140px; flex: 0.2; height: 40px;" name="m_sundayafter" value="${memberprofile.m_sundayafter }"
										class="form-control numberOnly" oninput="formatTime(this)" maxlength="4" placeholder="00:00">
							...
							<label for="email" style="font-size: 20px; margin-top:10px; padding:10px; form-labelmt-4" ><strong>거주지</label>
								...
								style="padding: 10px; background-color: white;">
									<div style="display: flex;">
										...
										<input type="text" class="form-control" style="margin: 2px;" value="${memberprofile.m_loadaddress}"id="sample4_roadAddress" name="m_loadaddress" placeholder="도로명주소" readonly>
										<input type="text" class="form-control"  style="margin: 2px;" value="${memberprofile.m_oldaddress}" id="sample4_jibunAddress" name="m_oldaddress" placeholder="지번주소" readonly>
										<span id="guide" style="color:#999;display:none"></span>
										<input type="text"  class="form-control"  style="margin: 2px;" value="${memberprofile.m_detailaddress}" id="sample4_detailAddress" name="m_detailaddress" placeholder="상세주소" >
										<input type="text" class="form-control"  style="margin: 2px;"  value="${memberprofile.m_optionaddress}"id="sample4_extraAddress" name="m_optionaddress" placeholder="참고항목" readonly>
								</div>

							<hr class="my-4">

							<button style="width:150px;" id="button1" class="btn btn-outline-dark" type="submit">수정완료</button>
								</div>
								</div>
  ...
  //input 숫자만 입력
    ...
    $("#button1").click(function(){
	    ...
	    if($("#nameDoubleChk").val() == "true" && isChecked == "true"
	        ...
	        console.log("m_programsub:"+m_programsub);
	    	...
	    	.done(function( html ) {
	    		...
	    		var variable2 = "0";
	    		  ...
	    		  var url = "/memberDetail?memberprofile_u_key=" + encodeURIComponent(u_key)+ "&trainerprofile_u_key=" + encodeURIComponent(variable2);;
