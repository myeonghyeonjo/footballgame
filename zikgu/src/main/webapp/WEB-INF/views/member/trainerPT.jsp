			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						...
						<h1 style="color:white;">PT 프로그램 등록</h1>
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- Introduction -->
							...
							<form  action="/PTinseretProcess" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
							<sec:authentication property="principal" var="principal"/>
	<input type="hidden" name="trainer_u_key" value="${principal.u_key}">
								...
								<div style="display: ;" class="dynamic_programsub1">
									...
									<h4 ><Strong style="color:black">	</Strong>
									...
									<div class="image-container3" style="flex: 1; " id="image_container3"></div>
									</div>
			...
			<!-- PT등록 Modal -->
<div class="modal fade" id="PTinsertModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel" style="color:black;">PT 등록</h1>
...
<!-- 상담신청 완료하기 누르면 발생 -->
<script>
	function clickInsertPT(formName) {
		formName.action = "/PTinseretProcess";
		formName.method = "post";
		formName.submit();
	}
</script>
