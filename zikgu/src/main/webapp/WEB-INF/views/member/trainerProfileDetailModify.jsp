							...
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
										...
										<p style="color:black" id="tf_introUpdateOk">${trainerprofile.tf_intro}</p>
			
										
										<textarea 	style="display: none; height:250px;color:black;" rows="2" cols="120" name="" >${trainerprofile.tf_intro}</textarea>
								  		<button	style="display: none;"  id="tf_introBtnOK" tf_id="${trainerprofile.tf_id}" class="btn btn-outline-dark">등록</button>
								  		<button  	style="display: none;"  id="tf_introBtnCancel" class="btn btn-outline-dark" >취소</button>
										<button style="display:on" type="button" id="tf_introBtn" class="btn btn-outline-dark">수정</button>
									</div>
...
<!-- 첨부파일 End -------------->										
						...
						<!-- Second Section -->
							...
							<ul class="statistics" style="display:none;">
									<li class="style1">
										<span class="icon solid fa-code-branch"></span>
										<strong>평일</strong> <input style="width:50px; border: none; background: transparent;" oninput="formatTime(this)" maxlength="4" id="tf_daymorningUpdate"  value="${trainerprofile.tf_daymorning }"> ~  <input style="width:50px; border: none; background: transparent;" oninput="formatTime(this)" maxlength="4" id="tf_dayafterUpdate"value="${trainerprofile.tf_dayafter }">
									</li>
									<li class="style2">
										<span class="icon fa-folder-open"></span>
										<strong>토요일</strong> <input style="width:50px; border: none; background: transparent;" oninput="formatTime(this)" maxlength="4" id="tf_saterdaymorningUpdate" value="${trainerprofile.tf_saterdaymorning }"> ~  <input style="width:50px; border: none; background: transparent;" oninput="formatTime(this)" maxlength="4" id="tf_saterdayafterUpdate" value="${trainerprofile.tf_saterafter }">
									</li>
									<li class="style3">
										<span class="icon solid fa-signal"></span>
										<strong>일요일</strong> <input style="width:50px; border: none; background: transparent;" oninput="formatTime(this)" maxlength="4" id="tf_sundaymorningUpdate" value="${trainerprofile.tf_sundaymorning }"> ~  <input style="width:50px; border: none; background: transparent;" oninput="formatTime(this)" maxlength="4" id="tf_sundayafterUpdate" value="${trainerprofile.tf_sundayafter }">
									</li>
									<li class="style4">
										<span class="icon solid fa-laptop"></span>
										<strong>휴무일</strong> <textarea 	style="display: ; color:white;" rows="2" cols="120" name="" id="tf_dayoffUpdate">${trainerprofile.tf_dayoff}</textarea>
									</li>
									<li class="style5">
										<span class="icon fa-gem"></span>
						...
						<!-- Get Started -->
							...
							<input type="hidden" id="tf_lessonunit_modify" value="${trainerprofile.tf_lessonunit }"></input>
							<div id="pt_schedulemodifyOK2" class="form-control"
					...
					<p style="text-align: center;  margin-top:10px; margin-bottom:0.5px"><strong style="color:white;">&nbsp;&nbsp;· ${trainerprofile.tf_lessontitle }</strong></p>
							...
							<hr style="margin: 12px; color:white; border-width:2px 0 0 0;">
								...
								style="padding: 10px; display:none; margin-top:10px; margin-left:45px; background-color: black; width:800px;">
								<input type="text" style="margin-left: 200px; margin-top:15px;width: 400px; height: 40px; color:white;"value="${ trainerprofile.tf_lessontitle}"> 

								<hr style="margin: 12px; color:white; border-width:2px 0 0 0;">
								<div class="container10">
									<input id="tf_lessonnumber_modify" type="text" style="margin-left:30px;  text-align:left; width:60px; color:white;" value="${trainerprofile.tf_lessonnumber }">
									<p style=" margin-top:20px; text-align:left; ">${trainerprofile.tf_lessonunit }</p>
								</div>
								<div class="container10">                
								<p style=" margin-left:560px; margin-top:-45px; "> ${trainerprofile.tf_lessonunit }당</p> <input id="tf_lessonprice_modify" type="text" style="margin-left:0px; margin-top:-65px; text-align:left; width:100px; color:white;" value="${trainerprofile.tf_lessonprice }"><p style=" margin-top:-45px; ">원</p>
								</div>
								<hr style="margin: 12px; color:white; border-width:2px 0 0 0;">
								<div class="container10">
									<input id="tf_lessonnumber2_modify" type="text" style="margin-left:30px;  text-align:left; width:60px; color:white;" value="${trainerprofile.tf_lessonnumber2 }">
									<p style=" margin-top:20px; text-align:left; ">${trainerprofile.tf_lessonunit }</p>
								</div>
								<div class="container10">                
								<p style=" margin-left:560px; margin-top:-45px; "> ${trainerprofile.tf_lessonunit }당</p> <input id="tf_lessonprice2_modify" type="text" style="margin-left:0px; margin-top:-65px; text-align:left; width:100px; color:white;" value="${trainerprofile.tf_lessonprice2 }"><p style=" margin-top:-45px; ">원</p>
								</div>
								<hr style="margin: 12px; color:white; border-width:2px 0 0 0;">
								<div class="container10">
									<input id="tf_lessonnumber3_modify" type="text" style="margin-left:30px;  text-align:left; width:60px; color:white;" value="${trainerprofile.tf_lessonnumber3 }">
									<p style=" margin-top:20px; text-align:left; ">${trainerprofile.tf_lessonunit }</p>
								</div>
								<div class="container10">                
								<p style=" margin-left:560px; margin-top:-45px; "> ${trainerprofile.tf_lessonunit }당</p> <input id="tf_lessonprice3_modify" type="text" style="margin-left:0px; margin-top:-65px; text-align:left; width:100px; color:white;" value="${trainerprofile.tf_lessonprice3 }"><p style=" margin-top:-45px; ">원</p>
								</div>
								<hr style="margin: 12px; color:white; border-width:2px 0 0 0;">
								<div class="container10">
									<input id="tf_lessonnumber4_modify" type="text" style="margin-left:30px;  text-align:left; width:60px; color:white;" value="${trainerprofile.tf_lessonnumber4 }">
									<p style=" margin-top:20px; text-align:left; ">${trainerprofile.tf_lessonunit }</p>
								</div>
								<div class="container10">                
								<p style=" margin-left:560px; margin-top:-45px; "> ${trainerprofile.tf_lessonunit }당</p> <input id="tf_lessonprice4_modify" type="text" style="margin-left:0px; margin-top:-65px; text-align:left; width:100px; color:white;" value="${trainerprofile.tf_lessonprice4 }"><p style=" margin-top:-45px; ">원</p>
								</div>
								<hr style="margin: 12px; color:white; border-width:2px 0 0 0;">
								
								
									<div class="container10" style="margin-bottom:10px;">  
									<P style="margin-left:200px;" >ㆍ 레슨 1회에</p> 	<select id="tf_lessontime_modify" class="form-select" id="country" name="tf_lessontime"
											style="margin: 10px; width: 100px; flex: 0.1; height: 40px; color:white;"
											 required>
									...
									<select class="form-select" id="tf_lessonoption_modify" name="tf_lessonoption"
											style="margin-left: 200px; margin-top:-10px;width: 400px; height: 40px; color:white;"
										 required>
											<option value="센터회원권을 별도로 결제해야함">센터회원권을 별도로 결제해야함</option>
											<option value="센터회원권을 별도로 결제해야할 필요없음">센터회원권을 별도로 결제해야할 필요없음</option>
										</select>
									<input type="text" style="margin-left: 200px; margin-top:15px;width: 400px; height: 40px; color:white;"value="${ trainerprofile.tf_lessonintro}"> 
								</div>		
						<button	style="display: none;"  id="pt_schedulemodifyOK" tf_id="${trainerprofile.tf_id}" class="btn btn-outline-dark">등록</button>
				  		<button  	style="display: none;"  id="tf_nameBtnCancel" class="btn btn-outline-dark" >취소</button>
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel" style="color:black;">삭제확인</h1>
      </div>
      <div class="modal-body">
        정말 PT를 삭제 하시겠습니까?
      </div>
...
<sec:authentication property="principal" var="principal"/>
	...
	<input type="hidden" name="tf_id" id="tf_id" value="${trainerprofile.tf_id}">
...
<script>
$(document).on('click', '#tf_nameBtn', function () {
...
$(document).on('click', '#tf_introBtn', function () {
	$(this).prev().css("display", "");
	$(this).prev().prev().css("display", "");
	$(this).prev().prev().prev().css("display", "");
	$(this).prev().prev().prev().prev().css("display", "none");
...
$(document).on('click', '#tf_PTmodifyBtn', function () {
	$(this).prev().css("display", "");
	$(this).prev().prev().css("display", "");
	$(this).prev().prev().prev().css("display", "");
...
$(document).on('click', '#tf_nameBtnCancel', function () {
...
$(document).on('click', '#tf_introBtnCancel', function () {
	$(this).prev().prev().css("display", "none");
	$(this).prev().prev().prev().css("display", "");
...
$(document).on('click', '#pt_schedulemodify', function () {
	$(this).prev().prev().css("display", "");
	$(this).prev().prev().prev().css("display", "");
	$(this).prev().prev().prev().prev().css("display", "none");
...
$(document).on('click', '#pt_schedulemodifyOK', function () {
	let tf_lessonnumber = $('#tf_lessonnumber_modify').val();
	let tf_lessonnumber2 = $('#tf_lessonnumber2_modify').val();
	let tf_lessonnumber3 = $('#tf_lessonnumber3_modify').val();
	let tf_lessonnumber4 = $('#tf_lessonnumber4_modify').val();
	let tf_lessonprice = $('#tf_lessonprice_modify').val();
	let tf_lessonprice2 = $('#tf_lessonprice2_modify').val();
	let tf_lessonprice3 = $('#tf_lessonprice3_modify').val();
	let tf_lessonprice4 = $('#tf_lessonprice4_modify').val();
	let tf_lessontime = $('#tf_lessontime_modify').val();
	let tf_lessonoption = $('#tf_lessonoption_modify').val();
	let tf_lessonunit = $('#tf_lessonunit_modify').val();
	let tf_lessontitle = $(this).prev().children('input').val();
	let tf_lessonintro = $(this).prev().children('input:eq(1)').val();
	let tf_id = $('#tf_id').val();
	console.log("tf_lessonnumber:"+tf_lessonnumber);
	$(this).prev().css("display", "none");
	$(this).prev().prev().css("display", "");
	$(this).next().css("display", "none");
	$(this).next().next().css("display", "");
	...
	$.ajax({
		method: "POST",
		url: "aj-updatept_lessonprice",
		data: { tf_lessonnumber: tf_lessonnumber,tf_lessonunit:tf_lessonunit, tf_id:tf_id, tf_lessonnumber2: tf_lessonnumber2,tf_lessonnumber3:tf_lessonnumber3, tf_lessonnumber4:tf_lessonnumber4 ,tf_lessonprice:tf_lessonprice,tf_lessonprice2:tf_lessonprice2,tf_lessonprice3:tf_lessonprice3,tf_lessonprice4:tf_lessonprice4,tf_lessontime:tf_lessontime,tf_lessonoption:tf_lessonoption, tf_lessontitle:tf_lessontitle,tf_lessonintro:tf_lessonintro }
	})
	.done(function( html ) {
		//console.log(html);
		$('#pt_schedulemodifyOK2').html(html);
	});
});
...
$(document).on('click', '#tf_nameBtnOK', function () {
	...
	$(this).next().css("display", "none");
	$(this).next().next().css("display", "");
	console.log("tf_nameBtnOK 누름");
	
	let tf_id = $(this).attr('tf_id');
	let tf_name = $(this).prev().val();
	
	console.log("tf_id:"+tf_id);
	console.log("tf_name:"+tf_name);
	...
	$.ajax({
		method: "POST",
		url: "aj-updatetf_name",
		data: { tf_id: tf_id,  tf_name: tf_name }
	})
	.done(function( html ) {
		//console.log(html);
		$('#tf_nameUpdateOk').html(html);
	});
});

$(document).on('click', '#tf_hanjulintroBtnOK', function () {
	$(this).css("display", "none");
	$(this).prev().prev().css("display", "");
	$(this).prev().css("display", "none");
	$(this).next().css("display", "none");
	$(this).next().next().css("display", "");
	console.log("tf_hanjulintroBtnOK 누름");
	
	let tf_id = $(this).attr('tf_id');
	let tf_hanjulintro = $(this).prev().val();
	
	console.log("tf_id:"+tf_id);
	console.log("tf_hanjulintro:"+tf_hanjulintro);
	...
	$.ajax({
		method: "POST",
		url: "aj-updatetf_hanjumintro",
		data: { tf_id: tf_id,  tf_hanjulintro: tf_hanjulintro }
	})
	.done(function( html ) {
		//console.log(html);
		$('#tf_hanjulintroUpdateOk').html(html);
	});
});

$(document).on('click', '#tf_introBtnOK', function () {
	$(this).css("display", "none");
	...
	let tf_id = $(this).attr('tf_id');
	let tf_intro = $(this).prev().val();
	
	console.log("tf_id:"+tf_id);
	console.log("tf_intro:"+tf_intro);
	...
	$.ajax({
		method: "POST",
		url: "aj-updatetf_intro",
		data: { tf_id: tf_id,  tf_intro: tf_intro }
	})
	.done(function( html ) {
		//console.log(html);
		$('#tf_introUpdateOk').html(html);
	});
});
...
$(document).on('click', '#tf_scheduleBtnOK', function () {
	...
	let tf_id = $(this).attr('tf_id');
	let tf_daymorning = $('#tf_daymorningUpdate').val();
	let tf_dayafter = $('#tf_dayafterUpdate').val();
	let tf_saterdaymorning = $('#tf_saterdaymorningUpdate').val();
	let tf_saterdayafter = $('#tf_saterdayafterUpdate').val();
	let tf_sundaymorning = $('#tf_sundaymorningUpdate').val();
	let tf_sundayafter = $('#tf_sundayafterUpdate').val();
	let tf_dayoff = $('#tf_dayoffUpdate').val();
	let tf_lessonintro = $('#tf_lessonintroUpdate').val();
	
	console.log("tf_id:"+tf_id);
	console.log("tf_daymorning:"+tf_daymorning);
	console.log("tf_dayafter:"+tf_dayafter);
	console.log("tf_saterdaymorning:"+tf_saterdaymorning);
	console.log("tf_saterdayafter:"+tf_saterdayafter);
	console.log("tf_sundaymorning:"+tf_sundaymorning);
	console.log("tf_sundayafter:"+tf_sundayafter);
	console.log("tf_dayoff:"+tf_dayoff);
	console.log("tf_lessonintro:"+tf_lessonintro);
	...
	$.ajax({
		method: "POST",
		url: "aj-updatetf_schedule",
		data: { tf_id: tf_id,  tf_daymorning: tf_daymorning , tf_dayafter:tf_dayafter, tf_saterdaymorning:tf_saterdaymorning,tf_saterdayafter:tf_saterdayafter,tf_sundaymorning:tf_sundaymorning, tf_sundayafter:tf_sundayafter, tf_dayoff:tf_dayoff, tf_lessonintro:tf_lessonintro}
	})
	.done(function( html ) {
		//console.log(html);
		$('#tf_scheduleUpdateOk').html(html);
		console.log("스케쥴업데이트 완료");
	});
});
