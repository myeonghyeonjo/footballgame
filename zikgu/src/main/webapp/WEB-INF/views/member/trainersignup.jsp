...
<div class="container">
  <main>
    ...
    <div class="py-5 text-center">
      ...
      <h2 style="color:black"><Strong>트레이너 회원 가입</Strong></h2>
    </div>
...
<fieldset class="fieldarea f3">
	...
	<input type="submit" id="button1" class="w-100 btn btn-primary btn-lg" value="회원가입" />
		    ...
		    if($("#agreement1").prop("checked") && $("#agreement2").prop("checked") && $("#nameDoubleChk").val() == "true" && $("#idDoubleChk").val() == "true" && $("#pwDoubleChk").val() == "true"  && $("#phoneDoubleChk").val() == "true"){
		       ...
		       console.log(name,id,password,phone);
		        ...
		        $.ajax({
		    		method: "POST",
		    		url: "/trainersignup",
		    		data: { username : id , uName : name , password:password, phone:phone, trainercheck:1 }
		    	})
		    	.done(function( html ) {
		    		console.log(html);
