...
<!-- 상담신청전 멤버프로필 등록 Modal -->
<div class="modal fade" id="consulting_memberprofilezero_Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel" style="color:black;">상담 신청</h1>
      ...
      <div class="modal-body">
        <p style="color:black;">상담신청을 하시려면 회원프로필을 등록하셔야 합니다. 프로필등록 페이지로 이동합니다.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">취소</button>
        <button type="button" class="btn btn-outline-primary" onclick="clickmemberprofileinsert(memberInfo)">확인</button>
      </div>
    </div>
  </div>
</div>	
...
<!-- 비회원 리뷰남기기 Modal -->
<div class="modal fade" id="reviewModalanonymous" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel" style="color:black;">리뷰 작성</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        리뷰 작성은 회원만 가능합니다. 로그인페이지로 이동합니다.
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">취소</button>
        <button type="button" class="btn btn-outline-primary" onclick="clickConfirmlogin(centerInfo)">확인</button>
...
<!-- 프로필 등록하기 누르면 발생 -->
function clickmemberprofileinsert(formName) {
		 var member_u_key =$('#member_u_key').val(); 
		  var url = "/memberProfile?u_key=" + encodeURIComponent(member_u_key);  
