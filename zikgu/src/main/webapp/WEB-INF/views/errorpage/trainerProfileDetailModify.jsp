...
u, i, center, dl, dt,ol, ul, li, fieldset,
			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						...
						<h1 style="color:white;">트레이너 프로필이 없습니다.</h1>
						<sec:authentication property="principal" var="principal" />
								<dd><a  href="/trainerProfile?u_key=${principal.u_key }">프로필등록</a></dd>
					</header>
<div style="visibility:hidden;">자리차지용</div>
<div style="visibility:hidden;">자리차지용</div>
<div style="visibility:hidden;">자리차지용</div>
<div style="visibility:hidden;">자리차지용</div>
<div style="visibility:hidden;">자리차지용</div>
