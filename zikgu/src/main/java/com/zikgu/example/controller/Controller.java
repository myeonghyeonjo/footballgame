...
request.getSession().setAttribute("prevPage", referrer);
	...
	public class AutoComController {
	    ...
	    public String centerinsertprocess(Pagination pagination,Model model,HttpServletRequest request,Center center,MultipartHttpServletRequest mhsq,@RequestParam("u_key") int u_key) throws IllegalStateException, IOException {
			...
			String realFolder = "/home/ec2-user/health/img/";  //파일저장위치
				...
				List<Center> list = boardservice.getcenterListOne(pagination);
				model.addAttribute("list",list);
		...
		@RequestMapping("/member_review_complete_dashboard")
	    public String member_review_complete_dashboard(Center center,Model model,@RequestParam("u_key") int u_key,Pagination pagination,TrainerProfile trainerprofile,HttpServletRequest request) {
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getmember_review_complete_Count(u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
				pagination.setU_key(u_key);
				List<Review> list = boardservice.getmember_review_complete_ListALL(pagination);
				List<TrainerProfile> trainerlist = boardservice.trainerListAll();
			model.addAttribute("pagination",pagination);
			model.addAttribute("sort","완료");
			model.addAttribute("list",list);
		...
		@RequestMapping("/member_review_waite_dashboard")
	    public String member_review_waite_dashboard(Center center,Model model,@RequestParam("u_key") int u_key,Pagination pagination,TrainerProfile trainerprofile,HttpServletRequest request) {
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getmember_review_waite_Count(u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
				pagination.setU_key(u_key);
				List<Review> list = boardservice.getmember_review_waite_ListALL(pagination);
				List<TrainerProfile> trainerlist = boardservice.trainerListAll();
			model.addAttribute("pagination",pagination);
			model.addAttribute("sort","대기");
			model.addAttribute("list",list);
		...
		@RequestMapping("/member_review_reject_dashboard")
	    public String member_review_reject_dashboard(Center center,Model model,@RequestParam("u_key") int u_key,Pagination pagination,TrainerProfile trainerprofile,HttpServletRequest request) {
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getmember_review_reject_Count(u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
				pagination.setU_key(u_key);
				List<Review> list = boardservice.getmember_review_reject_ListALL(pagination);
				List<TrainerProfile> trainerlist = boardservice.trainerListAll();
			model.addAttribute("pagination",pagination);
			model.addAttribute("sort","반려");
			model.addAttribute("list",list);
		...
		@RequestMapping("/member_review_dashboard_search_All")
	    public String member_review_dashboard_search_All(Center center,Model model,@RequestParam("u_key") int u_key,@RequestParam("keyword") String keyword,Pagination pagination,HttpServletRequest request) {
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
			   pagination.setU_key(u_key);
			   pagination.setKeyword(keyword);
				int listcount = boardservice.getmember_review_search_Count(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
				List<Review> list = boardservice.getmember_review_search_ListALL(pagination);
				List<TrainerProfile> trainerlist = boardservice.trainerListAll();
			model.addAttribute("pagination",pagination);
			model.addAttribute("sort","전체");
			model.addAttribute("keyword",keyword);
	    ...
	    public String centerconfirmcompletelist(Center center,Model model,@RequestParam("u_key") int u_key,Pagination pagination,HttpServletRequest request) {
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getcentercompleteListcount(u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
				pagination.setU_key(u_key);
			model.addAttribute("pagination",pagination);
			List<Center> list = boardservice.getcentercompleteListOne(pagination);
			model.addAttribute("list",list);
			model.addAttribute("sort","완료");
			
			return "/center/centerinsertlist";
	    }
		@RequestMapping("/centerconfirmwaitelist")
	    public String centerconfirmwaitelist(Center center,Model model,@RequestParam("u_key") int u_key,Pagination pagination,HttpServletRequest request) {
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getcenterwaiteListcount(u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
				pagination.setU_key(u_key);
			model.addAttribute("pagination",pagination);
			List<Center> list = boardservice.getcenterwaiteListOne(pagination);
			model.addAttribute("list",list);
			model.addAttribute("sort","대기");
			
			return "/center/centerinsertlist";
	    }
		@RequestMapping("/centerconfirmrejectlist")
	    public String centerconfirmrejectlist(Center center,Model model,@RequestParam("u_key") int u_key,Pagination pagination,HttpServletRequest request) {
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getcenterrejectListcount(u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
				pagination.setU_key(u_key);
			model.addAttribute("pagination",pagination);
			List<Center> list = boardservice.getcenterrejectListOne(pagination);
			model.addAttribute("list",list);
			model.addAttribute("sort","반려");
	    ...
	    public String clickcenterprofileDelete(TrainerProfile trainerprofile,Pagination pagination, HttpServletRequest request,Center center,Model model,@RequestParam("trainerprofile_u_key") int trainerprofile_u_key) {
			...
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getcenterListOneCount(trainerprofile_u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
				pagination.setU_key(trainerprofile_u_key);
			//List<Center> list = boardservice.getcenterListALL(pagination);
			List<Center> list = boardservice.getcenterListOne(pagination);
			model.addAttribute("pagination",pagination);
			model.addAttribute("list",list);
	    ...
	    public String trainerProfileDetail(Review review,User user,Model model,PT pt,TrainerProfile trainerprofile,@RequestParam("u_key") int u_key,@RequestParam("memberprofile_u_key") int memberprofile_u_key) {
				...
				String tf_loadaddress = trainerprofile.getTf_loadaddress();
				System.out.println("u_key:"+u_key);
				int memberprofilecountcheck= boardservice.getmemberprofilecountcheck(memberprofile_u_key);
				System.out.println("memberprofilecountcheck:"+memberprofilecountcheck);
		...
		@RequestMapping("/trainerProfileDetail_review")
	    public String trainerProfileDetail_review(Review review,Model model,PT pt,TrainerProfile trainerprofile,@RequestParam("u_key") int u_key,@RequestParam("memberprofile_u_key") int memberprofile_u_key) {
				System.out.println("u_key:"+u_key);
				trainerprofile = boardservice.trainerprofileDetail(u_key);
				String u_name = boardservice.getU_name2(u_key);
				...
				model.addAttribute("filelist_3",filelist_3);
			    model.addAttribute("memberprofilecountcheck",memberprofilecountcheck);
				return "/member/trainerProfileDetail_review";
	    }
		...
		@RequestMapping("/trainer_consulting_search_All")
	    public String trainer_consulting_search_All(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,TrainerProfile trainerprofile) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_key:"+u_key);
			trainerprofile = boardservice.trainerprofileDetail(u_key);
			int tf_id = trainerprofile.getTf_id();
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
			    pagination.setTf_id(tf_id);
			    pagination.setKeyword(keyword);
				int listcount = boardservice.gettrainerconsultingsearchlistCount(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();
				pagination.setTf_id(tf_id);			
			pagination.setKeyword(keyword);
			List<MemberProfile> list = boardservice.memberprofileconsultingsearchlist(pagination);
			model.addAttribute("pagination",pagination);
			model.addAttribute("keyword",keyword);
			model.addAttribute("sort","전체");
			model.addAttribute("u_key",u_key);
		...
		@RequestMapping("/trainer_consulting_complete_search_All")
	    public String trainer_consulting_complete_search_All(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,TrainerProfile trainerprofile) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_key:"+u_key);
			trainerprofile = boardservice.trainerprofileDetail(u_key);
			int tf_id = trainerprofile.getTf_id();
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
			    ...
			    pagination.setTf_id(tf_id);
			    pagination.setKeyword(keyword);
				int listcount = boardservice.gettrainerconsultingcompletesearchlistCount(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();
				pagination.setTf_id(tf_id);			
			pagination.setKeyword(keyword);
			List<MemberProfile> list = boardservice.memberprofileconsultingcompletesearchlist(pagination);
			model.addAttribute("pagination",pagination);
			model.addAttribute("keyword",keyword);
			model.addAttribute("sort","완료");
			model.addAttribute("u_key",u_key);
		...
		@RequestMapping("/trainer_consulting_waite_search_All")
	    public String trainer_consulting_waite_search_All(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,TrainerProfile trainerprofile) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_key:"+u_key);
			trainerprofile = boardservice.trainerprofileDetail(u_key);
			int tf_id = trainerprofile.getTf_id();
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
			    ...
			    pagination.setTf_id(tf_id);
			    pagination.setKeyword(keyword);
				int listcount = boardservice.gettrainerconsultingwaitesearchlistCount(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();
				pagination.setTf_id(tf_id);			
			pagination.setKeyword(keyword);
			List<MemberProfile> list = boardservice.memberprofileconsultingwaitesearchlist(pagination);
			model.addAttribute("pagination",pagination);
			model.addAttribute("keyword",keyword);
			model.addAttribute("sort","대기");
			model.addAttribute("u_key",u_key);
		...
		@RequestMapping("/center_insert_search_All")
	    public String center_insert_search_All(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,Center center) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_kye:"+u_key);
			String reqPage1 = request.getParameter("page");	  
			pagination.setKeyword(keyword);
			pagination.setU_key(u_key);
			   if(reqPage1 != null)
				   page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getcenterinsertSearchCount(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
			...
			model.addAttribute("keyword",keyword);
			model.addAttribute("sort","전체");
			List<Center> list = boardservice.getcenterinsertsearchList(pagination);
			model.addAttribute("list",list);
			return "/center/centerinsertlist";
	    }
		@RequestMapping("/center_insert_search_complete")
	    public String center_insert_search_complete(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,Center center) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_kye:"+u_key);
			String reqPage1 = request.getParameter("page");	  
			pagination.setKeyword(keyword);
			pagination.setU_key(u_key);
			   if(reqPage1 != null)
				   page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getcenterinsertSearchcompleteCount(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
			...
			model.addAttribute("keyword",keyword);
			model.addAttribute("sort","완료");
			List<Center> list = boardservice.getcenterinsertsearchcompleteList(pagination);
			model.addAttribute("list",list);
			return "/center/centerinsertlist";
	    }
		@RequestMapping("/center_insert_search_waite")
	    public String center_insert_search_waite(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,Center center) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_kye:"+u_key);
			String reqPage1 = request.getParameter("page");	  
			pagination.setKeyword(keyword);
			pagination.setU_key(u_key);
			   if(reqPage1 != null)
				   page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getcenterinsertSearchwaiteCount(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
			...
			model.addAttribute("keyword",keyword);
			model.addAttribute("sort","대기");
			List<Center> list = boardservice.getcenterinsertsearchwaiteList(pagination);
			model.addAttribute("list",list);
			return "/center/centerinsertlist";
	    }
		@RequestMapping("/center_insert_search_reject")
	    public String center_insert_search_reject(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,Center center) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_kye:"+u_key);
			String reqPage1 = request.getParameter("page");	  
			pagination.setKeyword(keyword);
			pagination.setU_key(u_key);
			   if(reqPage1 != null)
				   page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getcenterinsertSearchrejectCount(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
			...
			model.addAttribute("keyword",keyword);
			model.addAttribute("sort","반려");
			List<Center> list = boardservice.getcenterinsertsearchrejectList(pagination);
			model.addAttribute("list",list);
			return "/center/centerinsertlist";
	    }
		
		@RequestMapping("/consulting_search_All")
	    public String consulting_search_All(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,TrainerProfile trainerprofile) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_key:"+u_key);
			String reqPage1 = request.getParameter("page");	 
			pagination.setKeyword(keyword);
		...
		@RequestMapping("/consulting_search_complete")
	    public String consulting_search_complete(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,TrainerProfile trainerprofile) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_key:"+u_key);
			String reqPage1 = request.getParameter("page");	 
			pagination.setKeyword(keyword);
			pagination.setU_key(u_key);
			   if(reqPage1 != null)
				   page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getconsultingSearchcompleteCount(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
		...
		@RequestMapping("/consulting_search_waite")
	    public String consulting_search_waite(Model model,Pagination pagination, HttpServletRequest request ,@RequestParam("keyword") String keyword,@RequestParam("u_key") int u_key,TrainerProfile trainerprofile) {
			System.out.println("keyword:"+keyword);
			System.out.println("u_key:"+u_key);
			String reqPage1 = request.getParameter("page");	 
			pagination.setKeyword(keyword);
			pagination.setU_key(u_key);
			   if(reqPage1 != null)
				   page = Integer.parseInt(reqPage1);
				int listcount = boardservice.getconsultingSearchwaiteCount(pagination);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
			System.out.println("listcount:"+listcount);
		...
		@RequestMapping("/memberprofiledelete")
	    public String memberprofiledelete( Model model,User user,MemberProfile memberprofile) {
			int u_key =memberprofile.getU_key();
			System.out.println("u_key:"+u_key);
			boardservice.memberProfiledelete(memberprofile);
			userservice.memberprofileinsertcheckdelete(u_key);
			String u_key2 = String.valueOf(u_key);
			model.addAttribute("u_key", u_key);
			user = userservice.getUserdetail(u_key2);
			model.addAttribute("user",user);
	    ...
	    public String memberconsulting(Center center,Pagination pagination,HttpServletRequest request,User user, Model model,@RequestParam("u_key") int u_key,MemberProfile memberprofile,TrainerProfile trainerprofile) {		
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.gettrainerprofileconsultingCount(u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
		...
		@RequestMapping("/memberconsultingcomplete")
	    public String memberconsultingcomplete(Pagination pagination,HttpServletRequest request,User user, Model model,@RequestParam("u_key") int u_key,MemberProfile memberprofile,TrainerProfile trainerprofile) {	
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.gettrainerprofileconsultingcompleteCount(u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
		...
		@RequestMapping("/memberconsultingwaite")
	    public String memberconsultingwaite(Pagination pagination,HttpServletRequest request,User user, Model model,@RequestParam("u_key") int u_key,MemberProfile memberprofile,TrainerProfile trainerprofile) {	
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.gettrainerprofileconsultingwaiteCount(u_key);
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();			
	    ...
	    public String trainerconsultinglist(Pagination pagination,HttpServletRequest request,User user, Model model,@RequestParam("u_key") int u_key,MemberProfile memberprofile,TrainerProfile trainerprofile) {
			trainerprofile = boardservice.trainerprofileDetail(u_key);
			int tf_id = trainerprofile.getTf_id();
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.gettrainerconsultinglistCount(trainerprofile.getTf_id());
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();
				pagination.setTf_id(tf_id);
	
			List<MemberProfile> list = boardservice.memberprofileconsultinglist(pagination);
			model.addAttribute("pagination",pagination);
			model.addAttribute("u_key",u_key);
			model.addAttribute("trainerprofile",trainerprofile);
			model.addAttribute("list",list);
		...
		@RequestMapping("/trainerconsultingcompletelist")
	    public String trainerconsultingcompletelist(Pagination pagination,HttpServletRequest request,User user, Model model,@RequestParam("u_key") int u_key,MemberProfile memberprofile,TrainerProfile trainerprofile) {
			trainerprofile = boardservice.trainerprofileDetail(u_key);
			int tf_id = trainerprofile.getTf_id();
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.gettrainerconsultingcompletelistCount(trainerprofile.getTf_id());
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();
				pagination.setTf_id(tf_id);
	
			List<MemberProfile> list = boardservice.memberprofileconsultingcompletelist(pagination);
			model.addAttribute("pagination",pagination);
			model.addAttribute("u_key",u_key);
			model.addAttribute("trainerprofile",trainerprofile);
			model.addAttribute("list",list);
		...
		@RequestMapping("/trainerconsultingwaitelist")
	    public String trainerconsultingwaitelist(Pagination pagination,HttpServletRequest request,User user, Model model,@RequestParam("u_key") int u_key,MemberProfile memberprofile,TrainerProfile trainerprofile) {
			trainerprofile = boardservice.trainerprofileDetail(u_key);
			int tf_id = trainerprofile.getTf_id();
			String reqPage1 = request.getParameter("page");	  
			   if(reqPage1 != null)
					page = Integer.parseInt(reqPage1);
				int listcount = boardservice.gettrainerconsultingwaitelistCount(trainerprofile.getTf_id());
				pagination.setPage(page);
				pagination.setCount(listcount);
				pagination.init();
				pagination.setTf_id(tf_id);
	
			List<MemberProfile> list = boardservice.memberprofileconsultingwaitelist(pagination);
			model.addAttribute("pagination",pagination);
			model.addAttribute("u_key",u_key);
			model.addAttribute("trainerprofile",trainerprofile);
			model.addAttribute("list",list);
		...
		@RequestMapping("/aj-updatept_programsub")
	    public String updatept_programsub( Model model, PT pt,@RequestParam("pt_programsub") String pt_programsub,@RequestParam("pt_id") int pt_id,TrainerProfile trainerprofile) {
			System.out.println("pt_programsub:"+pt_programsub);
			System.out.println("pt_id:"+pt_id);
			pt.setPt_id(pt_id);
			pt.setPT_programsub(pt_programsub);	
			String[] pt_programsubArray = pt_programsub.split(",");
			String pt_programsub1 = pt_programsubArray[0];
			String pt_programsub2 = pt_programsubArray[1];
			String pt_programsub3 = pt_programsubArray[2];
			pt.setPt_programsub1(pt_programsub1);
			pt.setPt_programsub2(pt_programsub2);
			pt.setPt_programsub3(pt_programsub3);
			boardservice.updatept_programsub(pt);
			model.addAttribute("pt_programsub1",pt_programsub1);
			model.addAttribute("pt_programsub2",pt_programsub2);
			model.addAttribute("pt_programsub3",pt_programsub3);
			 return "/member/aj-updatept_programsub";
	    }
		...
		@RequestMapping("/trainerProfilePTInsert")
	    public String trainerProfilePTInsert( Model model,MultipartHttpServletRequest mhsq, FileDto filedto,PT pt,TrainerProfile trainerprofile) throws IllegalStateException, IOException {
			String tf_certificatetitle = filedto.getTf_certificatetitle();
			String tf_certificateoption = filedto.getTf_certificateoption();
			int tf_id = filedto.getTf_id();
			int u_key = trainerprofile.getU_key();
			System.out.println("u_key:"+u_key);
			 ...
			 File dir = new File(realFolder);
			   ...
			   if (mf.size() == 1 && mf.get(0).getOriginalFilename().equals("")) {
				   ...
				   for (int i = 0; i < mf.size(); i++) {
					   ...
					   // 파일 사이즈                
					   mf.get(i).transferTo(new File(savePath)); 	// 파일 저장                 
					   boardservice.filePTUpload(originalfileName, saveFileName, fileSize,savePath,filedto);
				   		}
			   	}
		...
		@RequestMapping("/aj-review_trainerprofilemodify")
	    public String review_trainerprofilemodify( Model model, Center center,PT pt,@RequestParam("trainer_u_key") int trainer_u_key,TrainerProfile trainerprofile) {
			 trainerprofile = boardservice.trainerprofileDetail(trainer_u_key);
			 String tf_loadaddress = trainerprofile.getTf_loadaddress();
			 String trainerprofile_u_key = String.valueOf(trainer_u_key);
			 System.out.println("trainerprofile_u_key:"+trainerprofile_u_key);
			 ...
			 return "/review/aj-reviewlist_trainerprofilemodify";
	    }
		 ...
		 public String reviewInsert( Model model,Review review,  @RequestPart(value = "test") Map<String, Object> test,MultipartHttpServletRequest mhsq, FileDto filedto,TrainerProfile trainerprofile) throws IllegalStateException, IOException {
			...
			String realFolder = "/home/ec2-user/health/img/";  //파일저장위치
			 ...
			 File dir = new File(realFolder);
			   ...
			   String trainerprofile_name = boardservice.gettrainer_profilename(trainerprofile_u_key);
			   String memberprofile_name = (String) test.get("memberprofile_name");
			   review.setTrainerprofile_name(trainerprofile_name);
