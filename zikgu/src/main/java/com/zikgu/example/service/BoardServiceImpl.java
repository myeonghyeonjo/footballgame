...
public class BoardServiceImpl implements BoardService {
	...
	public void certifiedPhoneNumber(String userPhoneNumber, int randomNumber) {
	    ...
	    params.put("type", "SMS");
	    params.put("text", "[Health Catch] 인증번호는" + "["+randomNumber+"]" + "입니다."); // 문자 내용 입력
	...
	public int getmember_review_search_complete_Count(Pagination pagination) {
		return boardmapper.getmember_review_search_complete_Count(pagination);
	}
	
	@Override
	public List<Review> getmember_review_search_complete_ListALL(Pagination pagination){
		return boardmapper.getmember_review_search_complete_ListALL(pagination);
	}
	
	@Override
	public int getmember_review_search_waite_Count(Pagination pagination) {
		return boardmapper.getmember_review_search_waite_Count(pagination);
	}
	
	@Override
	public List<Review> getmember_review_search_waite_ListALL(Pagination pagination){
		return boardmapper.getmember_review_search_waite_ListALL(pagination);
	}
	
	@Override
	public int getmember_review_search_reject_Count(Pagination pagination) {
		return boardmapper.getmember_review_search_reject_Count(pagination);
	}
	
	@Override
	public List<Review> getmember_review_search_reject_ListALL(Pagination pagination){
		return boardmapper.getmember_review_search_reject_ListALL(pagination);
	}
	
	@Override
	public void trainerprofileimginsertcheck(int tf_id) {
		boardmapper.trainerprofileimginsertcheck(tf_id);
	}
}
